...
public class AuthServerConfig {
    ...
    public TokenStore tokenStore() {
        return new JwtTokenStore(accessTokenConverter()); // JwtTokenStore manages JWT tokens using the provided
                                                          // JwtAccessTokenConverter.
    }

    // Additional configuration for client details, token services, etc. can be
    // added here.
}
