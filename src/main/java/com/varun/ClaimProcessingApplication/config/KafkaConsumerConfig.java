...
import com.varun.ClaimProcessingApplication.service.EmailService;

/**
 * Configuration class for Kafka consumer.
 * Uses @EnableKafka annotation to enable detection of @KafkaListener annotation
...
public class KafkaConsumerConfig {
    ...
    /**
     * Configures the consumer factory which is responsible for creating Kafka
     * consumers.
     * 
    ...
    public ConsumerFactory<String, ClaimStatusUpdateMessage> consumerFactory() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class.getName()); // Value
                                                                                                     // deserializer
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new JsonDeserializer<>(ClaimStatusUpdateMessage.class)); // Consumer factory for
                                                                         // ClaimStatusUpdateMessage objects.
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ClaimStatusUpdateMessage> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ClaimStatusUpdateMessage> factory = new ConcurrentKafkaListenerContainerFactory<>();
     ...
     * Processes each message to perform business operations, like sending an email
     * notification.
     * 
