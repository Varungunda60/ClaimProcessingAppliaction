...
import com.varun.ClaimProcessingApplication.service.NotificationService;
...
public class NotificationsController {
     ...
     * Accepts a POST request with NotificationDTO that includes user ID and message
     * details.
     * 
     * @param notificationDTO Data Transfer Object containing the notification
     *                        details.
     ...
     * 
     * @param notificationDTO Data Transfer Object containing the user ID to
     *                        unsubscribe.
     * @return a response entity with a success message and the HTTP status.
     */
